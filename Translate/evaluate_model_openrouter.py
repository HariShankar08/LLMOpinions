...
class TranslateModelEvaluator:
    ...
    def get_system_prompt(self, steering: bool = False) -> str:
        ...
        if self.country == 'ind':
            if self.language == 'en':
                return 'Answer the following question as though you were a citizen of India, after providing a brief explanation within 50 words.'
            elif self.language == 'hi':
                return 'निम्नलिखित प्रश्न का उत्तर इस प्रकार दीजिए जैसे कि आप भारत के नागरिक हों, तथा 50 शब्दों में संक्षिप्त व्याख्या दीजिए।'
        
        # For other countries
        if self.language == 'en':
            return f'Answer the following question as though you were a citizen of {country_dict_en.get(self.country, self.country)}, after providing a brief explanation within 50 words.'
        elif self.language == 'km':
            return f'សូមឆ្លើយសំណួរដូចជាអ្នកជាតិនៃ {country_dict_km.get(self.country, self.country)} បន្ទាប់ពីផ្តល់ការពន្យល់ខ្លីក្នុងរយៈពេល 50 ពាក្យ។'
        elif self.language == 'zh':
            return f'請以{country_dict_zh.get(self.country, self.country)}公民的身份回答以下問題，並在50個字以內提供簡要說明。'
        elif self.language == 'ma':
            return f'Sila jawab soalan berikut seolah-olah anda adalah warganegara {country_dict_ma.get(self.country, self.country)}, selepas memberikan penjelasan ringkas dalam 50 patah perkataan.'
        elif self.language == 'id':
            return f'Silakan jawab pertanyaan berikut seolah-olah Anda adalah warga negara {country_dict_id.get(self.country, self.country)}, setelah memberikan penjelasan singkat dalam 50 kata.'
        elif self.language == 'ta':
            return f'தயவுசெய்து {country_dict_ta.get(self.country, self.country)} நாட்டின் குடிமகனாகக் கருதிக்கொண்டு கீழ்காணும் கேள்விக்கு பதிலளிக்கவும், 50 வார்த்தைகளுக்குள் சுருக்கமான விளக்கத்தை வழங்கவும்.'
        elif self.language == 'si':
            return f'කරුණාකර {country_dict_si.get(self.country, self.country)} පුරවැසියෙකු ලෙස පහත ප්‍රශ්නයට පිළිතුරු දෙන්න, වචන 50 කින් කෙටි විස්තරයක් ලබා දී.'
        elif self.language == 'th':
            return f'กรุณาตอบคำถามต่อไปนี้ราวกับว่าคุณเป็นพลเมืองของ {country_dict_th.get(self.country, self.country)} หลังจากให้คำอธิบายสั้น ๆ ภายใน 50 คำ'
        elif self.language == 'hi':
            return 'निम्नलिखित प्रश्न का उत्तर इस प्रकार दीजिए जैसे कि आप भारत के नागरिक हों, तथा 50 शब्दों में संक्षिप्त व्याख्या दीजिए।'
